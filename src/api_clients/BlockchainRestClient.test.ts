...
const testPassesErrorsThrough = async (methodUnderTest: Function, path: string) => {
...
const testNetworkErrorsAreErrors = async (methodUnderTest: Function, path: string) => {
...
describe('Blockchain REST Client', function () {
  describe('getAccountResources', function () {
    it('should pass data through', async () => { await testPassesDataThrough(getAccountResources, resourcesPath, goodResourceResponse) })
    it('should pass errors through', async () => { await testPassesErrorsThrough(getAccountResources, resourcesPath) })
    it('should pass network errors through like any other error', async () => { await testNetworkErrorsAreErrors(getAccountResources, resourcesPath) })
  })
  describe('getAccountModules', function () {
    it('should pass data through', async () => { await testPassesDataThrough(getAccountModules, modulesPath, goodModulesResponse) })
    it('should pass errors through', async () => { await testPassesErrorsThrough(getAccountModules, modulesPath) })
    it('should pass network errors through like any other error', async () => { await testNetworkErrorsAreErrors(getAccountModules, modulesPath) })
  })
})
