...
export function accountcreationEventsColumn() {
  return [
    { Header: 'Transaction Version', accessor: 'transaction_version', Cell: TransactionVersion },
    { Header: 'Sent Events Key', accessor: 'sent_events_key', Cell: TruncatedCell },
    ...
    { Header: 'Delegated Withdrawal Capability', accessor: 'delegated_withdrawal_capability', Cell: BooleanCell },
    ...
    { Header: 'Compliance Key Rotation Events Key', accessor: 'compliance_key_rotation_events_key', Cell: TruncatedCell }
  ]
}
