export const mockAccountCreationEventsPageText = 'This is account creation events page'
const mockAccountCreationEventsPage = () => <div role="main">{mockAccountCreationEventsPageText}</div>

export const mockPreburnEventsPageText = 'This is preburn events page'
const mockPreburnEventsPage = () => <div role="main">{mockPreburnEventsPageText}</div>
